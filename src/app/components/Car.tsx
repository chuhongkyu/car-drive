...
import { useWheels } from "@/app/utils/useWheels";
import { Mesh, Quaternion, Vector3 } from "three";
import useCarStore from "@/app/utils/carStore";
import { motion } from "framer-motion-3d";
import useFollowCam from "@/app/utils/useFollowCam"
import JoystickContainer from "@/app/components/JoystickContainer";
...
export function Car( { carPosition }: {carPosition : number[]}) {
  ...
  const position:Triplet = [carPosition[0], carPosition[1], carPosition[2]];
